#!/usr/bin/env python3
"""
backend_v57.py - 北斗教育後端 v57
修復 GSAT 題庫 API

版本: v57_251226
新增: /api/gsat/questions, /api/gsat/subjects, /api/gsat/stats
"""
...
def get_gsat_questions():
    ...
    try:
        ...
        sql = '''
            ...
            FROM gsat_dedup_questions WHERE 1=1
        '''
        params = []
...
def get_gsat_stats():
    ...
    try:
        ...
        cur.execute('SELECT subject, COUNT(*) FROM gsat_dedup_questions GROUP BY subject')
...
if __name__ == '__main__':
    ...
    print(f"🚀 北斗教育 v57 啟動於 port {port}")
    print(f"📁 DB: {DB_PATH}")
